...
class LowerLeftCalculation: WindowCalculation, CornerCycleExpansionCalculation, QuartersRepeated {
    ...
    var horizontalSplitFraction: Float { RawmDefaults.horizontalSplitRatio.value / 100.0 }
    var verticalSplitFraction: Float { 1.0 - RawmDefaults.verticalSplitRatio.value / 100.0 }
